...
Specify how many IPv6 addresses should be assigned to the instance’s network interface.

### IPv6 Address Only

Enable this option if the instance should use IPv6 exclusively. This is required for IPv6-only VPCs or subnets. When enabled, the instance will have IPv6 as its sole address, and the IPv6 Address Count must be greater than zero.
