...
For proper network function, firewalld must be disabled on systems running RKE2. [Firewalld conflicts with Canal](https://docs.rke2.io/known_issues?_highlight=firewalld#firewalld-conflicts-with-default-networking), RKE2's default networking stack.
