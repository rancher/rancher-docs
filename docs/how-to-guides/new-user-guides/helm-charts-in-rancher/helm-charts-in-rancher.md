...
1. Click **☰**. 
1. Find **Explore Cluster** in the left navigation menu and select a cluster.
...
1. Find **Explore Cluster** in the left navigation menu and select a cluster.
1. In the left navigation menu on the **Cluster Dashboard**, click **Apps > Repositories**.
1. Find the row associated with the Git or HTTP-based repository you want to add a private CA to. Click **⋮**.
1. Select **Edit YAML**.
...
1. Turn on the legacy [feature flag](../../advanced-user-guides/enable-experimental-features/enable-experimental-features.md), if it isn't on already. This flag is turned on automatically if you upgrade Rancher while running a legacy app.
1. Click **☰**. 
1. Find **Explore Cluster** in the left navigation menu and select a cluster.
