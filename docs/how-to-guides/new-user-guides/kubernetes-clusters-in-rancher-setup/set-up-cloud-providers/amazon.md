...
10. Install the chart and confirm that daemonset `aws-cloud-controller-manager` is running  in the target namespace. The target namespace should be `kube-system`, unless you modified the target in step 6.
