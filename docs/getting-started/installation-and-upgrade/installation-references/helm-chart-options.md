...
| `systemRegistryInheritsPullSecrets`        | `false`                                               | `bool` - Set the default value of the `system-default-registry-pull-secrets` global setting to a comma seperated list of the `imagePullSecrets` used when installing Rancher. See [Global Registry documentation](/how-to-guides/new-user-guides/authentication-permissions-and-global-configuration/global-default-private-registry#optional-configure-credentials-for-the-default-registry) for more details. |
