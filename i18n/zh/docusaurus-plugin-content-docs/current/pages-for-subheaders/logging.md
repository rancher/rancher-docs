...
现在，Rancher 的日志管理由 [Banzai Cloud Logging operator](https://kube-logging.github.io/docs/) 提供支持，它取代了以前的内部解决方案。
...
有关如何配置日志缓冲区来满足企业需求的更完整说明，请参阅 [缓冲区](https://kube-logging.github.io/docs/configuration/plugins/outputs/buffer/)和 [Fluentd 配置](https://kube-logging.github.io/docs/configuration/fluentd/)的官方 BanzaiCloud 文档。
