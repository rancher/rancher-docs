...
|-----------------|-----------------|-----------------------|---------------------------|
| v2.9.12         |     v0.5.12     | &check;               | &cross;                   |
| v2.9.11         |     v0.5.11     | &check;               | &cross;                   |
| v2.9.10         |     v0.5.9      | &check;               | &cross;                   |
| v2.9.9          |     v0.5.9      | &check;               | &cross;                   |
| v2.9.8          |     v0.5.8      | &check;               | &cross;                   |
| v2.9.7          |     v0.5.7      | &check;               | &cross;                   |
