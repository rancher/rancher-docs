...
For more information, refer to the section on [importing existing clusters.](import-existing-clusters.md)
...
For more information, refer to the section on [imported K3s clusters.](import-existing-clusters.md)