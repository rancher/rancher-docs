...
For Rancher installed with Docker, refer to the same steps used up till 2.5 for [backups](back-up-docker-installed-rancher.md) and [restores.](restore-docker-installed-rancher.md)
