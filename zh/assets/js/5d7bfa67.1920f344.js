"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[1350],{
...
const metadata = {
    ...
    "title": "Kubernetes 工作负载和 Pod",
    "description": "了解在 Kubernetes 中构建复杂容器化应用程序的两种结构：Kubernetes 工作负载和 Pod",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/pages-for-subheaders/workloads-and-pods.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/docs/pages-for-subheaders/workloads-and-pods.md",
    "tags": [],
    "version": "current",
