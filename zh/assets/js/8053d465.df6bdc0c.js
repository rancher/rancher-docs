"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[23855],{
...
const metadata = {
    ...
    "title": "监控和告警",
    "description": "Prometheus 允许你查看来自不同 Rancher 和 Kubernetes 对象的指标。了解监控范围以及如何启用集群监控",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.7/pages-for-subheaders/monitoring-and-alerting.md",
    "sourceDirName": "pages-for-subheaders",
    "slug": "/pages-for-subheaders/monitoring-and-alerting",
    "permalink": "/zh/v2.7/pages-for-subheaders/monitoring-and-alerting",
    "draft": false,
