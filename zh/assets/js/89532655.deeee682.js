"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[96761],{
...
const metadata = {
    ...
    "id": "version-latest/integrations-in-rancher/fleet-gitops-at-scale/use-fleet-behind-a-proxy",
    "title": "在代理后使用 Fleet",
    "description": "在本节中，你将学习如何在一个设置中启用 Fleet，该设置有一个具有公共 IP 的 Rancher Server，以及一个没有公共 IP 但配置为使用代理的 Kubernetes 集群。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/integrations-in-rancher/fleet-gitops-at-scale/use-fleet-behind-a-proxy.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/integrations-in-rancher/fleet-gitops-at-scale/use-fleet-behind-a-proxy.md",
    "tags": [],
    "version": "latest",
