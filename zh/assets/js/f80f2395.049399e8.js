"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[21530],{
...
const metadata = {
    ...
    "id": "version-2.8/reference-guides/kubernetes-concepts",
    "title": "Kubernetes 概念",
    "description": "本文解释了 Kubernetes 的相关概念，以便让你更好地了解 Rancher 的运行机制。本文仅对 Kubernetes 组件进行了简单的描述。如需了解更多详情，请参见 Kubernetes 组件的官方文档。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/reference-guides/kubernetes-concepts.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/reference-guides/kubernetes-concepts.md",
    "tags": [],
    "version": "2.8",
