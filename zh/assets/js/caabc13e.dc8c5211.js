"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[14541],{
...
const metadata = {
    ...
    "id": "version-2.8/pages-for-subheaders/authentication-config",
    "title": "身份验证配置",
    "description": "Rancher 向 Kubernetes 添加的关键功能之一，就是集中式用户身份验证。此功能允许你的用户使用一组凭证对你的所有 Kubernetes 集群进行身份验证。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/pages-for-subheaders/authentication-config.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/pages-for-subheaders/authentication-config.md",
    "tags": [],
    "version": "2.8",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "td",
        "href": "/zh/v2.8/pages-for-subheaders/configure-microsoft-ad-federation-service-saml"
        ...
        parentName: "td",
        "href": "/zh/v2.8/pages-for-subheaders/configure-shibboleth-saml"
