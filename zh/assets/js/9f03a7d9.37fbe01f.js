"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[46185],{
...
const metadata = {
    ...
    "id": "version-2.8/reference-guides/backup-restore-configuration/backup-configuration",
    "title": "备份配置",
    "description": "你可以在备份创建页面配置调度，启用加密，并指定备份的存储位置。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/reference-guides/backup-restore-configuration/backup-configuration.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/reference-guides/backup-restore-configuration/backup-configuration.md",
    "tags": [],
    "version": "2.8",
