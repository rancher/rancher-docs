"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[4363],{
...
const metadata = {
    ...
    "id": "version-latest/reference-guides/best-practices/rancher-server/tips-for-running-rancher",
    "title": "Rancher 运行技巧",
    "description": "本指南适用于使用 Rancher 管理下游 Kubernetes 集群的用例。高可用设置可以防止 Rancher Server 不可用时无法访问下游集群。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/reference-guides/best-practices/rancher-server/tips-for-running-rancher.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/reference-guides/best-practices/rancher-server/tips-for-running-rancher.md",
    "tags": [],
    "version": "latest",
