"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[40952],{
...
const metadata = {
    ...
    "id": "version-latest/how-to-guides/advanced-user-guides/configure-layer-7-nginx-load-balancer",
    "title": "7 层 NGINX 负载均衡器上的 TLS 终止（Docker 安装）",
    "description": "如果你的开发或测试环境要求在负载均衡器上终止 TLS/SSL，而不是在 Rancher Server 上，请部署 Rancher 并配置负载均衡器。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/how-to-guides/advanced-user-guides/configure-layer-7-nginx-load-balancer.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/how-to-guides/advanced-user-guides/configure-layer-7-nginx-load-balancer.md",
    "tags": [],
    "version": "latest",
