"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[55836],{
...
const metadata = {
    ...
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.6/integrations-in-rancher/istio/istio.md",
...
const toc = [
    ...
    {
        value: '从之前的 Istio 版本进行迁移',
        id: '从之前的-istio-版本进行迁移',
        level: 2
    },
    {
        value: '访问可视化',
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        "id": "从之前的-istio-版本进行迁移"
    }, `从之前的 Istio 版本进行迁移`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `对于低于 1.7.x 版本的 Istio，不存在升级路径。要通过 Apps & Marketplace（Rancher 版本在 v2.6.5 之前）或 App（Rancher 版本在 v2.6.5+）成功安装 Istio，你需要在废弃的 Rancher UI 全局视图中禁用现有的 Istio。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `如果你有大量额外的 Istio CRD（自定义资源定义），可能需要考虑手动迁移那些在两个版本的 Istio 中都受支持的 CRD。你可以通过运行 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
    }, `kubectl get <resource> -n istio-system -o yaml`), ` 命令来完成此操作，将输出的 yaml 保存下来，并在新版本中重新部署。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `另一个方法是逐个手动卸载 Istio 资源，但保留在两个版本的 Istio 中都受支持且新版本不会安装的资源。这种方法更容易导致安装新版本时出现问题，但根据环境情况可能是一个不错的选择。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "访问可视化"
...
在集群中设置 Istio 后，你可以在 Rancher UI 中使用 Grafana、Prometheus 和 Kiali。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `要访问 Grafana 和 Prometheus 可视化：`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("ol", null, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ol"
        ...
        parentName: "p",
        "href": "/zh/v2.6/integrations-in-rancher/istio/configuration-options/#%E8%A6%86%E7%9B%96%E6%96%87%E4%BB%B6"
