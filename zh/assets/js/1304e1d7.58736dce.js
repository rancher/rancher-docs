"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[87388],{
...
const metadata = {
    ...
    "id": "version-2.8/pages-for-subheaders/manage-role-based-access-control-rbac",
    "title": "RBAC",
    "description": "Rancher 通过 用户 进行授权管理。如身份验证中所述，用户可以是本地用户，也可以是外部用户。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/pages-for-subheaders/manage-role-based-access-control-rbac.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/pages-for-subheaders/manage-role-based-access-control-rbac.md",
    "tags": [],
    "version": "2.8",
...
function MDXContent(_param) {
    ...
    }, `身份验证`), `中所述，用户可以是本地用户，也可以是外部用户。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `配置外部身份验证后，`, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
