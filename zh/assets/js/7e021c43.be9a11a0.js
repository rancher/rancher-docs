"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[64279],{
...
const metadata = {
    ...
    "id": "getting-started/installation-and-upgrade/installation-references/feature-flags",
    "title": "功能开关",
    "description": "使用功能开关（Feature Flag），你可以试用可选或实验性的功能并启用正在逐步淘汰的旧版功能。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/getting-started/installation-and-upgrade/installation-references/feature-flags.md",
