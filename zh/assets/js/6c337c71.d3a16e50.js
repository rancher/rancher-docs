...
const metadata = {
    ...
    "id": "version-latest/reference-guides/backup-restore-configuration/backup-configuration",
    "title": "备份配置",
    "description": "你可以在备份创建页面配置调度，启用加密，并指定备份的存储位置。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/reference-guides/backup-restore-configuration/backup-configuration.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/reference-guides/backup-restore-configuration/backup-configuration.md",
    "tags": [],
    "version": "latest",
    ...
    "previous": {
        ...
        "permalink": "/zh/pages-for-subheaders/backup-restore-configuration"
    },
    "next": {
        "title": "还原配置",
...
`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `这将确保密文包含一个名为 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        ...
        "id": "s3"
    }, `S3`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `S3 存储位置包含以下配置字段：`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("ol", null, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ol"
    }, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "li"
