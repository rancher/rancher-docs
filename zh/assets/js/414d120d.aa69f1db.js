"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[81637],{
...
const metadata = {
    ...
    "id": "version-latest/pages-for-subheaders/user-settings",
    "title": "用户设置",
    "description": "在 Rancher 中，每个用户都有很多与登录相关的设置，例如个人偏好、API 密钥等。你可以从用户设置菜单中配置这些设置。你可以单击主菜单中的头像来打开此菜单。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/pages-for-subheaders/user-settings.md",
    "sourceDirName": "pages-for-subheaders",
    "slug": "/pages-for-subheaders/user-settings",
    "permalink": "/zh/pages-for-subheaders/user-settings",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/pages-for-subheaders/user-settings.md",
    "tags": [],
    "version": "latest",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "li",
        "href": "/zh/reference-guides/user-settings/manage-node-templates"
        ...
        parentName: "li",
        "href": "/zh/reference-guides/user-settings/user-preferences"
