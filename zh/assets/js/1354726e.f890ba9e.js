"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[11739],{
...
const metadata = {
    ...
    "id": "how-to-guides/advanced-user-guides/open-ports-with-firewalld",
    "title": "使用 firewalld 打开端口",
    "description": "我们建议禁用 firewalld。如果你使用的是 Kubernetes 1.19 或更高版本，则必须关闭 firewalld。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/how-to-guides/advanced-user-guides/open-ports-with-firewalld.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/docs/how-to-guides/advanced-user-guides/open-ports-with-firewalld.md",
    "tags": [],
    "version": "current",
