"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[98188],{
...
const metadata = {
    ...
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.6/pages-for-subheaders/istio.md",
    ...
    "previous": {
        "title": "Harvester 集成",
        "permalink": "/zh/v2.6/integrations-in-rancher/harvester"
    },
    "next": {
        "title": "CPU 和内存分配",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p"
    }, `应用 & 市场市场`), `中提供。有权访问 Rancher Chart 应用商店的用户需要先设置 Istio，然后才能在项目中使用它。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "istio-附带的工具"
    ...
    }, `本节`), `。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `请注意，Istio v2（上游 Istio v1.7+）无法在离线环境中升级。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "设置指南"
        ...
        parentName: "p",
        "href": "/zh/v2.6/integrations-in-rancher/istio/disable-istio"
    }, `卸载 Istio`), `。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "迁移旧-istio-版本"
    }, `迁移旧 Istio 版本`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `如果你的 Istio 版本低于 1.7.x，则没有升级路径。要在 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, `Apps & Marketplace`), `（Rancher v2.6.5 之前的版本）或 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("strong", {
        parentName: "p"
    }, `App`), ` (Rancher v2.6.5+）页面安装 Istio，你需要在旧版 Rancher UI 的全局视图中禁用现有的 Istio。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `如果你有大量其他的 Istio CRD，你可能需要手动迁移两个 Istio 版本都支持的 CRD。为此，你可以运行 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
    }, `kubectl get <resource> -n istio-system -o yaml`), `，保存输出的 yaml，并在新版本中重新应用。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `另一种选择是一次手动卸载一个 Istio 资源，但保留两个 Istio 版本都支持且最新版本不会安装的资源。此方法有可能导致安装新版本时出现问题。你可以根据你的实际情况选择是否采用该方法。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "访问可视化"
        ...
        parentName: "p",
        "href": "/zh/v2.6/integrations-in-rancher/istio/rbac-for-istio"
        ...
        "id": "在离线环境中升级-istio"
    }, `在离线环境中升级 Istio`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `在 Rancher v2.6.x 及更高版本中，Istio 可能会在离线环境中升级。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `现在，Istio Pod 安全策略默认启用。新值 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
        ...
        parentName: "ol"
    }, `在 Rancher UI 中配置离线 Rancher 2.6.x 实例和离线自定义集群。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        parentName: "ol"
