"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[33647],{
...
const metadata = {
    ...
    "title": "Rancher Logging 集成",
    "description": "Rancher 集成了主流的日志服务。了解集成日志服务的要求和优势，并在你的集群上启用 Logging。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.6/integrations-in-rancher/logging/logging.md",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "li"
    }, `安装`), `。`)))), "**结果**：Logging 应用已部署到 `cattle-logging-system` 命名空间中。", /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        "id": "卸载-logging"
