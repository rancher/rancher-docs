"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[48048],{
...
const metadata = {
    ...
    "id": "version-2.7/pages-for-subheaders/authentication-config",
    "title": "身份验证配置",
    "description": "Rancher 向 Kubernetes 添加的关键功能之一，就是集中式用户身份验证。此功能允许你的用户使用一组凭证对你的所有 Kubernetes 集群进行身份验证。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.7/pages-for-subheaders/authentication-config.md",
    "sourceDirName": "pages-for-subheaders",
    "slug": "/pages-for-subheaders/authentication-config",
    "permalink": "/zh/v2.7/pages-for-subheaders/authentication-config",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.7/pages-for-subheaders/authentication-config.md",
    "tags": [],
    "version": "2.7",
    ...
    "previous": {
        "title": "身份验证、权限和全局配置",
        "permalink": "/zh/v2.7/pages-for-subheaders/authentication-permissions-and-global-configuration"
    },
    "next": {
        "title": "用户和组",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "td",
        "href": "/zh/v2.7/pages-for-subheaders/configure-microsoft-ad-federation-service-saml"
        ...
        parentName: "td",
        "href": "/zh/v2.7/pages-for-subheaders/configure-shibboleth-saml"
        ...
        parentName: "ul"
    }, `与提供商关联的外部用户，但是这些用户从未以本地用户身份登录到 Rancher。`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `由于此操作可能会导致许多资源丢失，因此你可能希望在提供程序上添加保护措施。为确保在禁用身份认证提供程序时不会运行此清理，请向相应的身份认证配置添加特殊注释。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `例如，要为 Azure AD 提供程序添加安全措施，请注释 `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
