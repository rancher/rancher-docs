"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[10782],{
...
const metadata = {
    ...
    "id": "version-latest/pages-for-subheaders/authentication-config",
    "title": "身份验证配置",
    "description": "Rancher 向 Kubernetes 添加的关键功能之一，就是集中式用户身份验证。此功能允许你的用户使用一组凭证对你的所有 Kubernetes 集群进行身份验证。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/pages-for-subheaders/authentication-config.md",
    "sourceDirName": "pages-for-subheaders",
    "slug": "/pages-for-subheaders/authentication-config",
    "permalink": "/zh/pages-for-subheaders/authentication-config",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/pages-for-subheaders/authentication-config.md",
    "tags": [],
    "version": "latest",
    ...
    "previous": {
        "title": "身份验证、权限和全局配置",
        "permalink": "/zh/pages-for-subheaders/authentication-permissions-and-global-configuration"
    },
    "next": {
        "title": "用户和组",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "td",
        "href": "/zh/pages-for-subheaders/configure-microsoft-ad-federation-service-saml"
        ...
        parentName: "td",
        "href": "/zh/pages-for-subheaders/configure-shibboleth-saml"
