"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[73565],{
...
const metadata = {
    ...
    "id": "version-latest/pages-for-subheaders/use-new-nodes-in-an-infra-provider",
    "title": "在云厂商的新节点上启动 Kubernetes",
    "description": "在 Rancher 中使用节点模板来创建 RKE 或 RKE2 集群时，每个生成的节点池都会显示在新的主机池选项卡中。你可以通过执行以下操作来查看主机池：",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/pages-for-subheaders/use-new-nodes-in-an-infra-provider.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/pages-for-subheaders/use-new-nodes-in-an-infra-provider.md",
    "tags": [],
    "version": "latest",
