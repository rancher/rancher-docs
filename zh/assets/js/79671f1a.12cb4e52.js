"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[95794],{
...
const metadata = {
    ...
    "id": "version-2.6/pages-for-subheaders/set-up-cloud-providers",
    "title": "设置 Cloud Provider",
    "description": "cloud provider 是 Kubernetes 中的一个模块，它提供了一个用于管理节点、负载均衡器和网络路由的接口。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.6/pages-for-subheaders/set-up-cloud-providers.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.6/pages-for-subheaders/set-up-cloud-providers.md",
    "tags": [],
    "version": "2.6",
