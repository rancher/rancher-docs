"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[16429],{
...
const metadata = {
    ...
    "id": "version-latest/reference-guides/rke1-template-example-yaml",
    "title": "RKE1 示例 YAML",
    "description": "以下是一个供参考的 RKE 模板配置文件示例。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/reference-guides/rke1-template-example-yaml.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/reference-guides/rke1-template-example-yaml.md",
    "tags": [],
    "version": "latest",
