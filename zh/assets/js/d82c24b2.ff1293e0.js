"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[56770],{
...
const metadata = {
    ...
    "id": "version-latest/getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/install-kubernetes",
    "title": "3. 安装 Kubernetes（Docker 安装请跳过）",
    "description": "如果你使用 Docker 在单个节点上安装 Rancher，请跳过本节。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/install-kubernetes.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/getting-started/installation-and-upgrade/other-installation-methods/air-gapped-helm-cli-install/install-kubernetes.md",
    "tags": [],
    "version": "latest",
