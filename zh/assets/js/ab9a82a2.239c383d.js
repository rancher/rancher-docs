...
const metadata = {
    ...
    "id": "version-latest/faq/container-network-interface-providers",
    "title": "CNI 网络插件",
    "description": "了解容器网络接口 (CNI)、Rancher 提供的 CNI 网络插件、提供商的功能，以及如何选择网络提供商",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/faq/container-network-interface-providers.md",
    "sourceDirName": "faq",
    "slug": "/faq/container-network-interface-providers",
    "permalink": "/zh/faq/container-network-interface-providers",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/faq/container-network-interface-providers.md",
    "tags": [],
    "version": "latest",
