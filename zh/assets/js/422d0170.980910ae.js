"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[63789],{
...
const metadata = {
    ...
    "id": "troubleshooting/other-troubleshooting-tips/dns",
    "title": "DNS",
    "description": "本文列出的命令/步骤可用于检查集群中的名称解析问题。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/troubleshooting/other-troubleshooting-tips/dns.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/docs/troubleshooting/other-troubleshooting-tips/dns.md",
    "tags": [],
    "version": "current",
