"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[59496],{
...
const metadata = {
    ...
    "title": "CNI 网络插件",
    "description": "了解容器网络接口 (CNI)、Rancher 提供的 CNI 网络插件、提供商的功能，以及如何选择网络提供商",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/faq/container-network-interface-providers.md",
    "sourceDirName": "faq",
