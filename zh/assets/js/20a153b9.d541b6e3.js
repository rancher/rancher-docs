"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[80607],{
...
const metadata = {
    ...
    "title": "使用 Docker 将 Rancher 安装到单个节点中",
    "description": "在开发和测试环境中，你可以使用 Docker 安装。在单个 Linux 主机上安装 Docker，然后使用一个 Docker 容器部署 Rancher。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.7/pages-for-subheaders/rancher-on-a-single-node-with-docker.md",
...
`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h2", {
        ...
        parentName: "p",
        "href": "/zh/v2.7/reference-guides/single-node-rancher-in-docker/advanced-options"
