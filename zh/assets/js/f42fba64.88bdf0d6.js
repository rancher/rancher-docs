...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "li"
    }, `在配置节点并执行缩减操作时，可能会删除当前配置的节点并配置新的节点以达到所需的节点数，而不是缩减所需的节点数量。这是 Cluster API 的一个问题，即将发布的版本会修复这个问题。一旦修复，Rancher 会更新文档。`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `如果你是习惯于 RKE1 配置的用户，请注意新的 RKE2 行为。`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "名词解释"
