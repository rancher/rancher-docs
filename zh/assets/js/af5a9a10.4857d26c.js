"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[66354],{
...
const metadata = {
    ...
    "id": "version-2.8/reference-guides/rancher-manager-architecture/architecture-recommendations",
    "title": "架构推荐",
    "description": "如果你准备在单个节点上安装 Rancher，我们推荐你分开部署 Rancher 与下游集群。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/reference-guides/rancher-manager-architecture/architecture-recommendations.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/reference-guides/rancher-manager-architecture/architecture-recommendations.md",
    "tags": [],
    "version": "2.8",
