"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[24171],{
...
const metadata = {
    ...
    "id": "version-2.6/reference-guides/best-practices/rancher-server/tips-for-running-rancher",
    "title": "Rancher 运行技巧",
    "description": "本指南适用于使用 Rancher 管理下游 Kubernetes 集群的用例。高可用设置可以防止 Rancher Server 不可用时无法访问下游集群。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.6/reference-guides/best-practices/rancher-server/tips-for-running-rancher.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.6/reference-guides/best-practices/rancher-server/tips-for-running-rancher.md",
    "tags": [],
    "version": "2.6",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p",
        "href": "/zh/v2.6/reference-guides/best-practices/rancher-server/on-premises-rancher-in-vsphere"
