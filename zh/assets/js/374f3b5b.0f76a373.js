"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[89148],{
...
const metadata = {
    ...
    "id": "version-latest/pages-for-subheaders/configure-microsoft-ad-federation-service-saml",
    "title": "配置 Microsoft AD FS (SAML)",
    "description": "如果你的组织使用 Microsoft 联合身份验证服务 (AD FS) 进行用户身份验证，你可以通过配置 Rancher 来允许用户使用 AD FS 凭证登录。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/pages-for-subheaders/configure-microsoft-ad-federation-service-saml.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/pages-for-subheaders/configure-microsoft-ad-federation-service-saml.md",
    "tags": [],
    "version": "latest",
