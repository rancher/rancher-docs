"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[77636],{
...
const metadata = {
    ...
    "id": "version-latest/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/troubleshooting",
    "title": "Rancher Server Kubernetes 集群的问题排查",
    "description": "本文介绍如何对安装在 Kubernetes 集群上的 Rancher 进行故障排除。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-latest/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/troubleshooting.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-latest/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/troubleshooting.md",
    "tags": [],
    "version": "latest",
