"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[85493],{
...
const metadata = {
    ...
    "id": "version-2.9/reference-guides/user-settings/user-settings",
    "title": "用户设置",
    "description": "在 Rancher 中，每个用户都有很多与登录相关的设置，例如个人偏好、API 密钥等。你可以从用户设置菜单中配置这些设置。你可以单击主菜单中的头像来打开此菜单。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.9/reference-guides/user-settings/user-settings.md",
    "sourceDirName": "reference-guides/user-settings",
    "slug": "/reference-guides/user-settings/",
    "permalink": "/zh/v2.9/reference-guides/user-settings/",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.9/reference-guides/user-settings/user-settings.md",
    "tags": [],
    "version": "2.9",
    ...
    "previous": {
        "title": "RBAC",
        "permalink": "/zh/v2.9/reference-guides/prometheus-federator/rbac"
    },
    "next": {
        "title": "API 密钥",
        "permalink": "/zh/v2.9/reference-guides/user-settings/api-keys"
    }
};
const assets = {};
const toc = [];
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "li",
        "href": "/zh/v2.9/reference-guides/user-settings/user-preferences"
