"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[9603],{
...
const metadata = {
    ...
    "id": "version-2.9/reference-guides/rke1-template-example-yaml",
    "title": "RKE1 示例 YAML",
    "description": "以下是一个供参考的 RKE 模板配置文件示例。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.9/reference-guides/rke1-template-example-yaml.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.9/reference-guides/rke1-template-example-yaml.md",
    "tags": [],
    "version": "2.9",
