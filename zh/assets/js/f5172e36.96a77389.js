"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[7039],{
...
const metadata = {
    ...
    "id": "version-2.9/getting-started/quick-start-guides/quick-start-guides",
    "title": "Rancher 部署快速入门指南",
    "description": "本章节中提供的指南，旨在帮助你快速启动一个用于 Rancher 的沙盒，以评估 Rancher 是否能满足你的使用需求。快速入门指南不适用于生产环境。如果你需要获取生产环境的操作指导，请参见安装。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.9/getting-started/quick-start-guides/quick-start-guides.md",
    ...
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.9/getting-started/quick-start-guides/quick-start-guides.md",
    "tags": [],
    "version": "2.9",
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        parentName: "p",
        "href": "/zh/v2.9/getting-started/quick-start-guides/deploy-rancher-manager/"
