"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[18975],{
...
const metadata = {
    ...
    "id": "reference-guides/backup-restore-configuration/examples",
    "title": "示例",
    "description": "本节包含 Backup 和 Restore 自定义资源的示例。",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/current/reference-guides/backup-restore-configuration/examples.md",
