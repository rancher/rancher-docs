"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[79683],{
...
const metadata = {
    ...
    "id": "version-2.5/getting-started/quick-start-guides/deploy-rancher-manager/aws",
    "title": "Rancher AWS Quick Start Guide",
    "description": "Read this step by step Rancher AWS guide to quickly deploy a Rancher server with a single-node downstream Kubernetes cluster attached.",
    "source": "@site/versioned_docs/version-2.5/getting-started/quick-start-guides/deploy-rancher-manager/aws.md",
    ...
    "permalink": "/zh/v2.5/getting-started/quick-start-guides/deploy-rancher-manager/aws",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.5/getting-started/quick-start-guides/deploy-rancher-manager/aws.md",
    "tags": [],
    "version": "2.5",
    ...
    "previous": {
        ...
        "permalink": "/zh/v2.5/getting-started/quick-start-guides/deploy-rancher-manager/"
    },
    "next": {
        "title": "Rancher Azure Quick Start Guide",
        "permalink": "/zh/v2.5/getting-started/quick-start-guides/deploy-rancher-manager/azure"
    }
};
const assets = {};
const toc = [
...
`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("li", {
        ...
        parentName: "p"
    }, `quickstart/rancher/aws`), `.`))), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h4", {
        "id": "result"
