"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[36387],{
...
const metadata = {
    ...
    "id": "version-2.8/pages-for-subheaders/use-new-nodes-in-an-infra-provider",
    "title": "在云厂商的新节点上启动 Kubernetes",
    "description": "在 Rancher 中使用节点模板来创建 RKE 或 RKE2 集群时，每个生成的节点池都会显示在新的主机池选项卡中。你可以通过执行以下操作来查看主机池：",
    "source": "@site/i18n/zh/docusaurus-plugin-content-docs/version-2.8/pages-for-subheaders/use-new-nodes-in-an-infra-provider.md",
    "sourceDirName": "pages-for-subheaders",
    "slug": "/pages-for-subheaders/use-new-nodes-in-an-infra-provider",
    "permalink": "/zh/v2.8/pages-for-subheaders/use-new-nodes-in-an-infra-provider",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/pages-for-subheaders/use-new-nodes-in-an-infra-provider.md",
    "tags": [],
    "version": "2.8",
