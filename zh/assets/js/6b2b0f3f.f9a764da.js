"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[77337],{
...
const metadata = {
    "unversionedId": "reference-guides/best-practices/deployment-types",
    "id": "version-2.0-2.4/reference-guides/best-practices/deployment-types",
    "title": "Tips for Running Rancher",
    "description": "A high-availability Kubernetes installation, defined as an installation of Rancher on a Kubernetes cluster with at least three nodes, should be used in any production installation of Rancher, as well as any installation deemed \"important.\" Multiple Rancher instances running on multiple nodes ensure high availability that cannot be accomplished with a single node environment.",
    "source": "@site/versioned_docs/version-2.0-2.4/reference-guides/best-practices/deployment-types.md",
    "sourceDirName": "reference-guides/best-practices",
    "slug": "/reference-guides/best-practices/deployment-types",
    "permalink": "/zh/v2.0-v2.4/reference-guides/best-practices/deployment-types",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.0-2.4/reference-guides/best-practices/deployment-types.md",
    "tags": [],
    "version": "2.0-2.4",
...
const toc = [
    ...
    {
        value: 'Don&#39;t Run Rancher on a Hosted Kubernetes Environment',
        id: 'dont-run-rancher-on-a-hosted-kubernetes-environment',
        level: 3
    },
    {
    ...
    {
        value: 'When using RKE: Backup the Statefile',
        id: 'when-using-rke-backup-the-statefile',
        level: 3
    },
    {
...
function MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)(MDXLayout, _object_spread_props(_object_spread({}, layoutProps, props), {
        ...
        "id": "dont-run-rancher-on-a-hosted-kubernetes-environment"
    }, `Don't Run Rancher on a Hosted Kubernetes Environment`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `When the Rancher server is installed on a Kubernetes cluster, it should not be run in a hosted Kubernetes environment such as Google's GKE, Amazon's EKS, or Microsoft's AKS. These hosted Kubernetes solutions do not expose etcd to a degree that is manageable for Rancher, and their customizations can interfere with Rancher operations.`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `It is strongly recommended to use hosted infrastructure such as Amazon's EC2 or Google's GCE instead. When you create a cluster using RKE on an infrastructure provider, you can configure the cluster to create etcd snapshots as a backup. You can then `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "https://rancher.com/docs/rke/latest/en/etcd-snapshots/"
    }, `use RKE`), ` or `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "/zh/v2.0-v2.4/pages-for-subheaders/backup-restore-and-disaster-recovery"
    }, `Rancher`), ` to restore your cluster from one of these snapshots. In a hosted Kubernetes environment, this backup and restore functionality is not supported.`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "make-sure-nodes-are-configured-correctly-for-kubernetes"
        ...
        parentName: "p",
        "href": "https://github.com/etcd-io/etcd/blob/master/Documentation/op-guide/performance.md"
    }, `etcd's performance op guide`)), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("h3", {
        "id": "when-using-rke-backup-the-statefile"
    }, `When using RKE: Backup the Statefile`), /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("p", null, `RKE keeps record of the cluster state in a file called `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
    ...
    }, `enable monitoring`), ` in the cluster, you can set up `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "/zh/v2.0-v2.4/explanations/integrations-in-rancher/notifiers"
    }, `a notification channel`), ` and `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("a", {
        parentName: "p",
        "href": "/zh/v2.0-v2.4/pages-for-subheaders/cluster-alerts"
    }, `cluster alerts`), ` to let you know if your cluster is approaching its capacity. You can also use the Prometheus and Grafana monitoring framework to establish a baseline for key metrics as you scale.`));
}
