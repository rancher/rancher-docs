...
The [`ldapsearch`](https://manpages.ubuntu.com/manpages/jammy/en/man1/ldapsearch.1.html) tool allows you to query your AD server to learn about the schema used for user and group objects.
