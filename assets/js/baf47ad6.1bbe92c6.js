"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[10355],{
...
;// CONCATENATED MODULE: ./versioned_docs/version-2.5/shared-files/_common-ports-table.md
...
;// CONCATENATED MODULE: ./versioned_docs/version-2.5/getting-started/installation-and-upgrade/installation-requirements/port-requirements.md
...
const metadata = {
    ...
    "id": "version-2.5/getting-started/installation-and-upgrade/installation-requirements/port-requirements",
    "title": "Port Requirements",
    "description": "Read about port requirements needed in order for Rancher to operate properly, both for Rancher nodes and downstream Kubernetes cluster nodes",
...
const port_requirements_toc = [
    ...
    {
        value: 'Ports for Rancher Server Nodes on RancherD or RKE2',
        id: 'ports-for-rancher-server-nodes-on-rancherd-or-rke2',
        level: 3
    },
    {
...
function port_requirements_MDXContent(_param) {
    ...
    return /*#__PURE__*/ (0,esm/* mdx */.kt)(port_requirements_MDXLayout, port_requirements_object_spread_props(port_requirements_object_spread({}, port_requirements_layoutProps, props), {
        ...
        "id": "ports-for-rancher-server-nodes-on-rancherd-or-rke2"
    }, `Ports for Rancher Server Nodes on RancherD or RKE2`), /*#__PURE__*/ (0,esm/* mdx */.kt)("blockquote", null, /*#__PURE__*/ (0,esm/* mdx */.kt)("p", {
        parentName: "blockquote"
    }, /*#__PURE__*/ (0,esm/* mdx */.kt)("strong", {
        parentName: "p"
    }, `Note:`), ` RancherD was an experimental feature available as part of Rancher v2.5.4 through v2.5.10 but is now deprecated and not available for recent releases.`)), /*#__PURE__*/ (0,esm/* mdx */.kt)("details", null, /*#__PURE__*/ (0,esm/* mdx */.kt)("summary", null, "Click to expand"), /*#__PURE__*/ (0,esm/* mdx */.kt)("p", null, `The RancherD (or RKE2) server needs port 6443 and 9345 to be accessible by other nodes in the cluster.`), /*#__PURE__*/ (0,esm/* mdx */.kt)("p", null, `All nodes need to be able to reach other nodes over UDP port 8472 when Flannel VXLAN is used.`), /*#__PURE__*/ (0,esm/* mdx */.kt)("p", null, `If you wish to utilize the metrics server, you will need to open port 10250 on each node.`), /*#__PURE__*/ (0,esm/* mdx */.kt)("p", null, /*#__PURE__*/ (0,esm/* mdx */.kt)("strong", {
        parentName: "p"
    }, `Important:`), ` The VXLAN port on nodes should not be exposed to the world as it opens up your cluster network to be accessed by anyone. Run your nodes behind a firewall/security group that disables access to port 8472.`), /*#__PURE__*/ (0,esm/* mdx */.kt)("figcaption", null, "Inbound Rules for RancherD or RKE2 Server Nodes"), /*#__PURE__*/ (0,esm/* mdx */.kt)("table", null, /*#__PURE__*/ (0,esm/* mdx */.kt)("thead", {
        parentName: "table"
    }, /*#__PURE__*/ (0,esm/* mdx */.kt)("tr", {
        parentName: "thead"
    }, /*#__PURE__*/ (0,esm/* mdx */.kt)("th", {
        ...
        parentName: "tr",
        "align": null
    }, `RancherD/RKE2 agent nodes`), /*#__PURE__*/ (0,esm/* mdx */.kt)("td", {
        parentName: "tr",
        "align": null
    }, `Kubernetes API`)), /*#__PURE__*/ (0,esm/* mdx */.kt)("tr", {
        parentName: "tbody"
        ...
        parentName: "tr",
        "align": null
    }, `RancherD/RKE2 server and agent nodes`), /*#__PURE__*/ (0,esm/* mdx */.kt)("td", {
        parentName: "tr",
        "align": null
    }, `Required only for Flannel VXLAN`)), /*#__PURE__*/ (0,esm/* mdx */.kt)("tr", {
        parentName: "tbody"
        ...
        parentName: "tr",
        "align": null
    }, `RancherD/RKE2 server nodes`), /*#__PURE__*/ (0,esm/* mdx */.kt)("td", {
        parentName: "tr",
        "align": null
        ...
        parentName: "tr",
        "align": null
    }, `NodePort port range`)), /*#__PURE__*/ (0,esm/* mdx */.kt)("tr", {
        parentName: "tbody"
    }, /*#__PURE__*/ (0,esm/* mdx */.kt)("td", {
        parentName: "tr",
        "align": null
        ...
        parentName: "tr",
        "align": null
    }, `Rancher agent, Rancher UI/API, kubectl. Not needed if you have LB doing TLS termination.`)))), /*#__PURE__*/ (0,esm/* mdx */.kt)("p", null, `Typically all outbound traffic is allowed.`)), /*#__PURE__*/ (0,esm/* mdx */.kt)("h3", {
        "id": "ports-for-rancher-server-in-docker"
