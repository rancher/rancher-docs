"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[11027],{
...
const metadata = {
    ...
    "id": "version-2.8/how-to-guides/advanced-user-guides/tune-etcd-for-large-installs",
    "title": "Tuning etcd for Large Installations",
    "description": "When Rancher is used to manage a large infrastructure it is recommended to increase the default keyspace for etcd from the default 2 GB. The maximum setting is 8 GB and the host should have enough RAM to keep the entire dataset in memory. When increasing this value you should also increase the size of the host. The keyspace size can also be adjusted in smaller installations if you anticipate a high rate of change of pods during the garbage collection interval.",
    "source": "@site/versioned_docs/version-2.8/how-to-guides/advanced-user-guides/tune-etcd-for-large-installs.md",
    "sourceDirName": "how-to-guides/advanced-user-guides",
    "slug": "/how-to-guides/advanced-user-guides/tune-etcd-for-large-installs",
    "permalink": "/v2.8/how-to-guides/advanced-user-guides/tune-etcd-for-large-installs",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/how-to-guides/advanced-user-guides/tune-etcd-for-large-installs.md",
    "tags": [],
    "version": "2.8",
