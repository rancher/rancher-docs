"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[54961],{
...
const metadata = {
    ...
    "title": "Continuous Delivery",
    "description": "Continuous Delivery with Fleet comes preinstalled in Rancher and can't be fully disabled. However, the Fleet feature for GitOps continuous delivery may be disabled using the continuous-delivery feature flag.",
    "source": "@site/versioned_docs/version-2.9/how-to-guides/advanced-user-guides/enable-experimental-features/continuous-delivery.md",
    ...
    "next": {
        ...
        "permalink": "/v2.9/how-to-guides/advanced-user-guides/open-ports-with-firewalld"
    }
};
const assets = {};
const toc = [];
...
function MDXContent(_param) {
    ...
    }, `Continuous Delivery with Fleet`), ` comes preinstalled in Rancher and can't be fully disabled. However, the Fleet feature for GitOps continuous delivery may be disabled using the `, /*#__PURE__*/ (0,_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .mdx */ .kt)("inlineCode", {
        parentName: "p"
