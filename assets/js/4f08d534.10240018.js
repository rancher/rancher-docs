"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[14399],{
...
const metadata = {
    ...
    "title": "Rancher Outscale Quick Start Guide",
    "description": "Read this step by step Rancher Outscale guide to quickly deploy a Rancher server with a single-node downstream Kubernetes cluster attached.",
    "source": "@site/versioned_docs/version-2.8/getting-started/quick-start-guides/deploy-rancher-manager/outscale-qs.md",
    ...
    "next": {
        ...
        "permalink": "/v2.8/getting-started/quick-start-guides/deploy-rancher-manager/helm-cli"
    }
};
const assets = {};
const toc = [
