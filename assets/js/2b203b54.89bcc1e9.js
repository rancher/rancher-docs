"use strict";
(self["webpackChunkrancher_docs"] = self["webpackChunkrancher_docs"] || []).push([[85236],{
...
const metadata = {
    ...
    "id": "version-2.8/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-gke",
    "title": "Installing Rancher on a Google Kubernetes Engine Cluster",
    "description": "In this section, you'll learn how to install Rancher using Google Kubernetes Engine.",
    "source": "@site/versioned_docs/version-2.8/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-gke.md",
    ...
    "permalink": "/v2.8/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-gke",
    "draft": false,
    "editUrl": "https://github.com/rancher/rancher-docs/edit/main/versioned_docs/version-2.8/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/rancher-on-gke.md",
    "tags": [],
    "version": "2.8",
    ...
    "next": {
        ...
        "permalink": "/v2.8/getting-started/installation-and-upgrade/install-upgrade-on-a-kubernetes-cluster/upgrade-a-hardened-cluster-to-k8s-v1-25"
    }
};
const assets = {};
const toc = [
